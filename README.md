...
```bash
npx ai-workflow-agent-skills install --agents claude --skills organize-docs,frame-opportunity,research-opportunity,stress-test-opportunity,author-prd,review-prd,plan-roadmap,explore-ux
```
...
```bash
npx ai-workflow-agent-skills install --agents codex --skills 'planning/author-prd,discovery/*,design/explore-ux'
```
...
```bash
DEST=~/.agents/skills
mkdir -p "$DEST" && cp -R skills/docs/organize-docs skills/discovery/frame-opportunity skills/discovery/research-opportunity skills/discovery/stress-test-opportunity skills/planning/author-prd skills/planning/review-prd skills/planning/plan-roadmap skills/design/explore-ux "$DEST/"
```
